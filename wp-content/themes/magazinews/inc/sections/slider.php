...
if ( ! function_exists( 'magazinews_render_slider_section' ) ) :
   ...
   */
   function magazinews_render_slider_section( $content_details = array() ) {
        ...
        <div id="featured-slider" class="relative modern-slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "infinite": true, "speed": 500, "dots": false, "arrows":true, "autoplay": <?php echo $options['slider_auto_play'] ? 'true' : 'false'; ?>, "draggable": true, "fade": false }'>
